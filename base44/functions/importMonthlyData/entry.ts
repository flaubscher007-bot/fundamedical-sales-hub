  ...
  try {
    ...
    if (type === 'calls') {
      records = rows.map(r => ({
        ...
        law_firm: r['Law Firm'] || '',
        x3_account_no: r['Law Firm:PatientName (linked to item)'] || '',
        law_firm_status: r['Law Firm:Status'] || '',
        dc_stm: r['Law Firm:DC - STM'] || '',
        kac: r['Law Firm:KAC'] || '',
      ...
      records = rows.map(r => ({
        ...
        law_firm: r['Law Firm'] || '',
        x3_account_no: r['Law Firm:X3 ACC NO. (linked to item)'] || '',
        dc_stm: r['Law Firm:DC - STM'] || '',
        kac: r['Law Firm:KAC'] || '',
      ...
      records = rows.map(r => ({
        law_firm: r['Law Firm'] || r['PatientName'] || '',
        x3_account_no: r['Law Firm:X3 ACC NO.'] || '',
        status: r['Law Firm:New Status July 2025'] || '',
        dc_stm: r['Law Firm:DC - STM'] || '',
        business_unit: r['Law Firm:BUSINESS UNIT'] || '',
        kac: r['Law Firm:KAC'] || '',
        bul: r['Law Firm:BUL JAN 2026'] || '',
        movement: r['MOVEMENT'] || '',
